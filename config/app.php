...
use App\Providers\ProgramServiceProvider;
use App\Providers\IdCardServiceProvider;
use App\Providers\LevelServiceProvider;
use App\Providers\NonCreditServiceProvider;
use App\Providers\ProfileServiceProvider;
use App\Providers\StaffDirectoryProvider;
use App\Providers\StudentServiceProvider;
use App\Providers\YearSemesterServiceProvider;
...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Alpine Knowledge Management'),
    ...
    */
    ...
    'providers' => array(
        ...
        StaffDirectoryProvider::class,
        NonCreditServiceProvider::class,
        ProfileServiceProvider::class,
        LevelServiceProvider::class,
        StudentServiceProvider::class,
        CertificateServiceProvider::class,
        LevelServiceProvider::class,
        ProgramServiceProvider::class,
        YearSemesterServiceProvider::class,
