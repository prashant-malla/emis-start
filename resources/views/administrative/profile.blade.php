                            ...
                            <div class="card">
                                <div class="text-center p-3 overlay-box"
                                    ...
                                    <div class="profile-photo">
                                        <img src="{{$administrative->profile_image}}" width="100"
                                             class="img-fluid rounded-circle" alt="">
                                    </div>
                                    <h3 class="mt-3 mb-1 text-white">{{$administrative->name}}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <p>{!! $administrative->note !!}</p>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Staff ID</strong>
                                            <span class="mb-0">{{$administrative->staff_id}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Education</strong>
                                            <span class="mb-0">{{$administrative->qualification}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Department</strong>
                                            <span class="mb-0">{{$administrative->department->department ?? 'N/A'}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Sub Department</strong>
                                            <span class="mb-0">{{$administrative->sub_department->name ?? 'N/A'}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Designation</strong>
                                            <span class="mb-0">{{$administrative->designation->title ?? 'N/A'}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Work Shift</strong>
                                            <span class="mb-0">{{$administrative->work_shift ?? 'N/A'}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Work Experience</strong>
                                            <span class="mb-0">{{$administrative->work_experience ?? 0}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Service Type</strong>
                                            <span class="mb-0">{{$administrative->service_type ?? 'N/A'}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Contract Type</strong>
                                            <span class="mb-0">{{$administrative->contract_type ?? 'N/A'}}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Date of Joining</strong>
                                            <span
                                                class="mb-0">{{date('j F, Y', strtotime($administrative->date_of_joining)) ?? 'N/A'}}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
{{--                                </div>--}}
{{--                                <div class="card-body">--}}
{{--                                    <p class="mb-0">{{$administrative->current_address}}</p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                    </div>
                                        ...
                                        <div id="about-me" class="tab-pane fade active show">
                                            <div class="profile-personal-info pt-4">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->gender}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{date('j F, Y', strtotime($administrative->dob)) ?? 'N/A'}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->phone}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->marital_status}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->permanent_address}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->current_address}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->father_name ?? 'N/A'}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->mother_name}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{$administrative->emergency_phone}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
