...
@php
    ...
    $routeMapping = [
        'Receptionist' => 'receptionist.notice.store',
    ];
    $routeName = $routeMapping[$userRole ?? ''] ?? 'notice.store';
@endphp
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            if ($('#notice_to').val()) {
                updateFieldBasedOnNoticeTo($('#notice_to').val())
            } else {
                $('#role').hide();
                $('#academic_year').hide();
                $('#batch').hide();
            ...
            $('#notice_to').on('change', function() {
                updateFieldBasedOnNoticeTo($(this).val())
            });
        })

        function updateFieldBasedOnNoticeTo(value) {
            if (value == 'Staff') {
                $('#level_id').val('').change();
