                            ...
                            <form action="
                                 @if(\Illuminate\Support\Facades\Auth::guard('staff')->check())
                                    @if(auth()->guard('staff')->user()->role->role == 'Librarian')
                                        {{route('librarian_book.update', $book)}}
                                    @endif
                                 @elseif(\Illuminate\Support\Facades\Auth::user()->role == 'admin')
                                 {{route('admin_book.update', $book)}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="author" value='{{old('author')?old('author'):(isset($book) ? $book->author : '')}}' placeholder="Enter Author" >
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rack_number" value='{{old('rack_number')?old('rack_number'):(isset($book) ? $book->rack_number : '')}}' placeholder="Enter Rack Number" >
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" name="book_type" id="book_type" >
                                            ...
                                            <option value="Text Books" {{ $book->book_type == 'Text Books' ? 'selected' : ''  }}>Text Books</option>
                                            <option value="Journal/periodicals"  {{ $book->book_type == 'Journal/periodicals' ? 'selected' : ''  }}>Journal/periodicals</option>
                                            <option value="E-learning Resources"  {{ $book->book_type == 'E-learning Resources' ? 'selected' : ''  }}>E-learning Resources</option>
                                            <option value="Magazine" {{ $book->book_type == 'Magazine' ? 'selected' : ''  }}>Magazine</option>
                                            <option value="Research papers"  {{ $book->book_type == 'Research papers' ? 'selected' : ''  }}>Research papers</option>
                                            <option value="Reference"  {{ $book->book_type =='Reference' ? 'selected' : ''  }}>Reference</option>
                                            <option value="Other Books"  {{ $book->book_type == 'Other Books' ? 'selected' : ''  }}>Other Books</option>
                                        </select>
                                        <span class="text-danger">@error('book_type')
                                            {{ $message }}
                                            @enderror</span>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">File(PDF) <span class="text-muted small">(Max:
                                                50MB)</label>
                                            <input name="document" type="file" class="dropify" data-height="100" accept=".pdf" data-default-file="{{ $book->document}}"/>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Cover Image <span class="text-muted small">(Max:
                                                1MB)</label>
                                            <input name="cover_image" type="file" class="dropify" data-height="100" accept="image/*" data-default-file="{{ $book->image}}"/>
...
@section('scripts')
    ...
    <script>
        //File Dropify
        $('.dropify').dropify().on('dropify.afterClear', addDeleteFileInput);
