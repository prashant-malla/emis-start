        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{isset($data) ? 'Edit' : 'Add'}} Fiscal
                            Year</a>
                    </li>
                </ol>
            </div>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{isset($data) ? 'Edit' : 'Add'}} Fiscal Year</h4>
                            </div>
                            <div class="card-body">
                                @include('includes.message')

                                @php($formAction = isset($data) ? route('fiscal_year.update', $data) :
                                route('fiscal_year.store'))
                                ...
                                <form class="form" action="{{ $formAction }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- Do not allow editing status for active fiscal year --}}
