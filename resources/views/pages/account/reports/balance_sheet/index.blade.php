...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="card print-content">
            ...
            <div class="card-body">
                <form id="filter-form" action="{{route('account.reports.balancesheet.filter')}}" method="GET">
                    <div class="row">
                ...
                <table id="report-table" class="table table-bordered">
                    <thead>
                        <tr class="bg-dark text-white">
                            <th>Account</th>
                            <th class="text-right" width="25%">Balance ({{config('app.currency')}})</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
...
<script src="{{asset('js/accounts/reports/balance-sheet.js')}}"></script>
<script>
    $(function(){
