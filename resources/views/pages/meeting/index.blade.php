    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @include('pages.meeting.partials.filter', [
                        'filterAction' => '',
                    ])
                </div>
            </div>
                                        ...
                                        <table id="example3" class="display" style="min-width: 845px">
                                            ...
                                            @foreach($meeting as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="{{route('meeting.show',$data['id']) }} " class="btn btn-sm btn-warning m-1"><i class="la la-eye"></i></a>
                                                            <a href="{{route('meeting.edit',$data['id']) }} " class="btn btn-sm btn-primary m-1"><i class="la la-pencil"></i></a>
                                                            <form method="post" action="{{route('meeting.destroy',$data->id)}}" onsubmit="return confirm('Are you sure?')">
                                                                @method('delete')
                                                                @csrf
