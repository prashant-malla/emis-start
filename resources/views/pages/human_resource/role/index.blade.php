                                        ...
                                        <table id="example3" class="display" style="min-width: 750px">
                                            ...
                                            @foreach(\App\Models\Role::all() as $role)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="{{route('role.edit',$role['id']) }} " class='btn btn-sm btn-primary m-1'>
                                                                <i class="la la-pencil"></i></a>
                                                            <form method="POST" action=" {{route('role.destroy',$role->id)}}" onsubmit="return confirm('Are you sure?')">
                                                                @method('delete')
                                                                @csrf
