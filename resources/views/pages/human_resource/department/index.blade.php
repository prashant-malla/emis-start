                                        ...
                                        <table id="example3" class="display" style="min-width: 750px">
                                            ...
                                            @foreach(\App\Models\Department::all() as $department)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="{{route('department.edit',$department['id']) }} " class='btn btn-sm btn-primary m-1'>
                                                                <i class="la la-pencil"></i></a>
                                                            <form method="POST" action=" {{route('department.destroy',$department->id)}}" onsubmit="return confirm('Are you sure?')">
                                                                @method('delete')
                                                                @csrf
