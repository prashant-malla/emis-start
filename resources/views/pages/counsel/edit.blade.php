                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Edit Counselling</h5>
                        </div>
                        <div class="card-body">
            ...
            $('#section_id').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var response = JSON.parse(response);
                        $('#counselte_name').empty();
                        $('#counselte_name').append(`<option value="" disabled selected>Select Student</option>`);
                        response.forEach(element => {
                            $('#counselte_name').append(`<option value="${element['id']}">${element['sname']}</option>`);
                        });
        ...
        $(document).ready(function () {
            @isset($counsel)
                ...
                if(selectedValue == "Enrollment Counselling"){
                    $("#level, #program, #year_semester, #group, #counseleeIdCard").hide();
            ...
            $("input[name='counselling_type']").change(function () {
                ...
                if (selectedValue == "Enrollment Counselling") {
                    ...
                    $("#level, #program, #year_semester, #group, #counseleeIdCard").show();
                    $("#student_name").addClass("d-none").val("");
                    $('#counselte_select').removeClass("d-none");
                    $('#ethnicity').hide();
                }
