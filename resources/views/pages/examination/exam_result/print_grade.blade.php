                ...
                <div class="student-details clear">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td>
                                <b>{{ getYearSemesterLabel($exam->yearSemester->type) }}:</b>
                                {{ $exam->yearSemester->name }}
                                ({{ $studentEnrollment?->section->group_name }})
                            </td>
                            <td class="right-house"><b>Roll No:</b> {{ $studentEnrollment?->roll }}</td>
                        </tr>
                    </table>
                            ...
                            <thead style="border-bottom: 1px solid #00000052;font-weight:bold;">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p style="margin:4px 0px 0px 0px;font-size: 12px;">
                                            <b>TH</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="float:right;">PR</b>
                                        </p>
                                    </td>
                                    <td>Final Grade</td>
                                    <td>Grade Point</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    @php
                                                        $theory =
                                                            ($mark->theory_mark / $subject->theory_full_marks) * 100;
                                                        $grade = getGrade($theory, $grades);
                                                        echo '<b class="theory"style="">' .
                                                            ($grade ? $grade['grade_name'] : '') .
                                                            '</b>';
                                                        $practical =
                                                            ($mark->practical_mark / $subject->practical_full_marks) *
                                                            100;
                                                        ...
                                                        echo '<b style="float:right;">' .
                                                            ...
                                                            '</b>';
                                                        $mark_t_p =
                                                            $mark->theory_mark + ($mark->practical_mark / 100) * 100;
