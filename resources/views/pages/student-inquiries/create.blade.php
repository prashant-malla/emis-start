                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ isset($routeAs) ? route($routeAs . 'student-inquiries.store') : '#' }} "
...
@section('scripts')
    ...
    <script>
        //On Changing Level to display names of the respective programs.
        $(document).ready(function() {
    ...
    <script>
        //On Changing Program to display names of the respective year semester.
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#year_semester_id').append(
                        `<option value="0" disabled selected>Select Year/Semester</option>`);
                    response.forEach(element => {
                        $('#year_semester_id').append(
                            `<option value="${element['id']}">${element['name']}</option>`);
                    });
    ...
    <script>
        //On Changing year semester to display names of the respective sections.
        $(document).ready(function() {
