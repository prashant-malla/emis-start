                        ...
                        <div id="list-view" class="tab-pane fade active show col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{route('academic_calendar.create')}}" class="btn btn-primary">+ Add new</a>
                                </div>
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        @foreach(json_decode($calendar->file, true) as $key => $media_gallery)
                                                            <a href="{{ url('/files/calendar/'.$media_gallery) }}" target="_blank" data-toggle="lightbox" data-title="Package Media Gallery" data-gallery="gallery">
