                        ...
                        <div id="list-view" class="tab-pane fade active show col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Feedback Type List</h4>
                                    <a href="{{route('complain-type.create')}}" class="btn btn-primary">+ Add new</a>
                                </div>
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     {{--       <a href="
                                                            ...
                                                            <a href="  {{route('complain-type.edit',$item['id']) }} " class='btn btn-sm btn-primary m-1'>
                                                            <i class="la la-pencil"></i></a>
                                                        {{--    <form method="POST" action="
                                                              ...
                                                              @elseif(\Illuminate\Support\Facades\Auth::user()->role == 'Admin')
                                                                ...
                                                                <form action="{{route('complain-type.destroy',$item->id)}}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                                @method('delete')
                                                                @csrf
