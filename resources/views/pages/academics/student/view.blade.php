                ...
                <div class="col-md-4">
                    <div class="member-card">
                        <div class="member-name">
                            ...
                            <strong><h5>{{$student->sname ?? 'N/A'}}</h5></strong>
                        </div>
                        <div>
                    ...
                    <div class="member-card">
                        ...
                        <div>
                           ...
                           <tr>
                                ...
                                <tr>
                                    <th>Father's Job</th>
                                    <td>{{$student->parent->father_job ?? 'N/A'}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Mother's Job</th>
                                    <td>{{$student->parent->mother_job ?? 'N/A'}}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(!empty($student->slc_certificate))
                                            <a href="{{$student->slc_certificate}}" target="_blank">
                                                <img src="https://cdn-icons-png.flaticon.com/512/892/892303.png" alt="" style="height: 35px; width: 35px">
                                            </a>@endif
                                    </td>
                                </tr>
                                <tr>
