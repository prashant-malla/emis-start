    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('payment_history.index') }}" method="GET">
                        <div class="row">
            ...
            <h4 class="text-center">Total Collection: {{ config('app.currency') }}
                {{ convertToMoney($paymentHistories->sum('paid_amount')) }}</h4>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($paymentHistories as $key => $paymentHistory)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('payment.print', $paymentHistory) }}"
