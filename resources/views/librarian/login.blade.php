            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 col-12">
                    <div class="main-login h-100">
                        <div>
                            <p class="mb-2">Hello <span class="text-primary">Librarian</span>!</p>
                            <h4 class="pb-3 pb-xxl-4">Login to your Account</h4>
                            <div class="login-form">
                                <form action="{{route('librarian.login')}}" method="POST" class="login-form">
                                @csrf
                                ...
                                <div class="alert alert-info" role="alert">
                                    ...
                                    <ul>
                                        <li><a href="/student/login" class="text-decoration-none">Student</a></li>
                                        <li><a href="/" class="link-danger text-decoration-none">Super Admin</a></li>
                                        <li><a href="/teacher/login" class="link-info text-decoration-none">Teacher</a></li>
                                    </ul>
                                </div>
                                @enderror
