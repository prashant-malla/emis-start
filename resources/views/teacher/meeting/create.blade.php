                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('teacher.meeting.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select" name="academic_year_id"
                                                ...
                                                @foreach ($academicYears as $academicYear)
                                                    <option value="{{ $academicYear->id }}" {{ collect(old('academic_year_id'))->contains($academicYear->id) ? 'selected' : '' }}>
                                                        {{ $academicYear->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select" name="batch_id" id="batch_id" required>
                                                ...
                                                @foreach ($batches as $batch)
                                                    <option value="{{ $batch->id }}" {{ collect(old('batch_id'))->contains($batch->id) ? 'selected' : '' }}>
                                                        {{ $batch->title }}
                                                    </option>
                                                @endforeach
                                            </select>
