                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="main-login h-100">
                            <div>
                                <p class="mb-2">Hello <span class="text-primary">Front Desk</span>!</p>
                                <h4 class="pb-3 pb-xxl-4">Login to your Account</h4>
                                <div class="login-form">
                                    <form action="{{ route('receptionist.login') }}" method="POST" class="login-form">
                                        @csrf
                                        <input type="email" name="email" class="form-control" value="{{ old('email') }}"
                                            placeholder="Email">
                                        <div class="position-relative">
                                            <i class="fas fa-eye-slash" onclick="showHidePassword()"
                                                id="eyePassword"></i>
                                            <input type="password" name="password" id="exampleFormControlInput2" class="form-control" placeholder="Password">
                                        </div>
                                    ...
                                    @error('email')
                                        <div class="alert alert-info" role="alert">
                                            You sure you are <b>Librarian</b>? <br />
                                            If not you can login as:
                                            <ul>
                                                <li>
                                                    <a href="/student/login" class="text-decoration-none">Student</a>
                                                </li>
                                                <li>
                                                    <a href="/" class="link-danger text-decoration-none">Super
                                                        Admin</a>
                                                </li>
                                                <li>
                                                    <a href="/teacher/login"
                                                        class="link-info text-decoration-none">Teacher</a>
                                                </li>
                                            </ul>
                                        </div>
                                    @enderror
