...
namespace App\Http\Controllers\Administrative\Counselling;
...
class CounselController extends Controller
{
    ...
    {
        $counsellings = Counsel::where('staff_id', Auth::guard('staff')->user()->id)->latest()->get();
    ...
    public function store(StoreCounselRequest $request)
    {
        ...
        return redirect()->route('administrative_counsel.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(UpdateCounselRequest $request, $id)
    {
        ...
        return redirect()->route('administrative_counsel.index')->with('success', 'Updated Successfully');
        // }
        // else {
    ...
    public function destroy(Counsel $counsel, $id)
    {
        ...
        $counsel ->delete();
        return redirect()->route('administrative_counsel.index')->with('success', 'Deleted successfully');
    }
}
