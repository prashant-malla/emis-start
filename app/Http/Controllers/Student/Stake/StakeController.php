...
namespace App\Http\Controllers\Student\Stake;
...
class StakeController extends Controller
{
    ...
    {
        $stakes = Stake::latest()->where('student_id', Auth::guard('student')->user()->id)->get();
    ...
    public function store(StoreStakeRequest $request)
    {
        ...
        return redirect()->route('student_stake.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(UpdateStakeRequest $request)
    {
        ...
        return redirect()->route('student_stake.index')->with('success', 'Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $stake ->delete();
        return redirect()->route('student_stake.index')->with('success', 'Deleted successfully');
    }
}
