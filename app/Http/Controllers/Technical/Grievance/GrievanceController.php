...
namespace App\Http\Controllers\Technical\Grievance;
...
class GrievanceController extends Controller
{
    ...
    public function store(StoreGrievanceRequest $request)
    {
        ...
        return redirect()->route('technical_grievance.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(StoreGrievanceRequest $request)
    {
        ...
        return redirect()->route('technical_grievance.index')->with('success', 'Updated Successfully');
    }
    ...
    public function destroy(Grievance $grievance, $id)
    {
        ...
        $grievance ->delete();
        return redirect()->route('technical_grievance.index')->with('success', 'Deleted successfully');
    }
}
