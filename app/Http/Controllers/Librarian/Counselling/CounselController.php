...
namespace App\Http\Controllers\Librarian\Counselling;
...
class CounselController extends Controller
{
    ...
    public function store(StoreCounselRequest $request)
    {
        ...
        return redirect()->route('librarian_counsel.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(UpdateCounselRequest $request, $id)
    {
        ...
        return redirect()->route('librarian_counsel.index')->with('success', 'Updated Successfully');
        // }
        // else {
    ...
    public function destroy(Counsel $counsel, $id)
    {
        ...
        $counsel ->delete();
        return redirect()->route('librarian_counsel.index')->with('success', 'Deleted successfully');
    }
}
