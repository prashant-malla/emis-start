...
namespace App\Http\Controllers\NonTechnical\Stake;
...
class StakeController extends Controller
{
    ...
    public function store(StoreStakeRequest $request)
    {
        ...
        return redirect()->route('nontechnical_stake.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(UpdateStakeRequest $request)
    {
        ...
        return redirect()->route('nontechnical_stake.index')->with('success', 'Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $stake ->delete();
        return redirect()->route('nontechnical_stake.index')->with('success', 'Deleted successfully');
    }
}
