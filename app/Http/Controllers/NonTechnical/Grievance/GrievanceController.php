...
namespace App\Http\Controllers\NonTechnical\Grievance;
...
class GrievanceController extends Controller
{
    ...
    public function store(StoreGrievanceRequest $request)
    {
        ...
        return redirect()->route('nontechnical_grievance.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(StoreGrievanceRequest $request)
    {
        ...
        return redirect()->route('nontechnical_grievance.index')->with('success', 'Updated Successfully');
    }
    ...
    public function destroy(Grievance $grievance, $id)
    {
        ...
        $grievance ->delete();
        return redirect()->route('nontechnical_grievance.index')->with('success', 'Deleted successfully');
    }
}
