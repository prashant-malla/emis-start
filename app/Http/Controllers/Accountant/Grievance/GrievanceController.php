...
namespace App\Http\Controllers\Accountant\Grievance;
...
class GrievanceController extends Controller
{
    ...
    public function store(StoreGrievanceRequest $request)
    {
        ...
        return redirect()->route('accountant_grievance.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(StoreGrievanceRequest $request)
    {
        ...
        return redirect()->route('accountant_grievance.index')->with('success', 'Updated Successfully');
    }
    ...
    public function destroy(Grievance $grievance, $id)
    {
        ...
        $grievance ->delete();
        return redirect()->route('accountant_grievance.index')->with('success', 'Deleted successfully');
    }
}
