...
namespace App\Http\Controllers\Accountant\Stake;
...
class StakeController extends Controller
{
    ...
    public function store(StoreStakeRequest $request)
    {
        ...
        return redirect()->route('accountant_stake.index')->with('success', 'Created Successfully');
    }
    ...
    public function update(UpdateStakeRequest $request)
    {
        ...
        return redirect()->route('accountant_stake.index')->with('success', 'Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $stake ->delete();
        return redirect()->route('accountant_stake.index')->with('success', 'Deleted successfully');
    }
}
